...
项目采用“单一代码负责人 + 多 AI 分工”模式：

- Claude：阅读文档后负责主要代码、测试和技术文档。
- 豆包：负责 WSL、Git、Docker、CLion 等可执行命令解释。
- DeepSeek：负责概念解释、报错分析和局部修复建议。
- 项目所有者：确认需求、审阅代码、运行验收并决定是否合并。
